...
<head>
	...
	<link href="{{asset('back-end/css/bootstrap-responsive.min.cs')}}s" rel="stylesheet">
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{route('category.index')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Categories</span></a></li>
